...
#     global  discount_entry, amount_var, amount_after_discount_var
...
#                           font=("Arial", 12),)
#     frame_2.place(x=10, y=10, relwidth=0.4, relheight=0.9)

#     columns = ("Quantity","Description", "Rate",  "Amount")
